pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~directory_lister.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~directory_lister.adb");
...
package body ada_main is
   ...
   E138 : Short_Integer; pragma Import (Ada, E138, "gnat__directory_operations_E");
   E133 : Short_Integer; pragma Import (Ada, E133, "system__regexp_E");
   E053 : Short_Integer; pragma Import (Ada, E053, "ada__directories_E");
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_directory_lister");
...
--  BEGIN Object file/option list
   --   ./directory_lister.o
   --   -L./
   --   -L/usr/local/lib/gcc/powerpc-unknown-openbsd/11.2.0/adalib/
   --   -static
   --   -lgnat
